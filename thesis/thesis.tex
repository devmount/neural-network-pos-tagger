...
After introducing the test sets, the different training groups were evaluated according to the parameter configuration presented in chapter \ref{c.training.tuning}. The following section show the evaluation results for the different architectures.
