...
\begin{figure}[H]
	...
	\caption[FNN Evaluation: Number of Past Words]{The evaluation results of the FNN for parameter $p$: the number of preceding words. Number of correctly tagged words in percent.}
...
\begin{figure}[H]
	...
	\caption[FNN Evaluation: Number of Past Words]{The evaluation results of the FNN for parameter $e$: the embedding size. Number of correctly tagged words in percent.}
...
\begin{figure}[H]
	...
	\caption[FNN Evaluation: Number of Training Epochs]{The evaluation results of the FNN for parameter $n$: the number of training epochs. Number of correctly tagged words in percent.}
	\label{f.evaluation.fnn.n}
\end{figure}

Overall, all models of the different training epochs achieved similar results on the known test. However, the model with $n=80$ stands out a bit with the highest accuracy of 87.7\% and the second highest $\kappa=0.808$. For the unknown test, the model with only 5 training epochs achieved a maximum accuracy of 68.8\% and $\kappa=0.622$.

\begin{figure}[H]
	\includegraphics[width=\textwidth]{images/evaluation_fnn_e2}
	\caption[FNN Evaluation: Number of Training Epochs]{The evaluation results of the FNN for parameter $n$: the number of training epochs. Number of correctly tagged words in percent.}
	\label{f.evaluation.fnn.e2}
\end{figure}

\begin{figure}[H]
	\includegraphics[width=\textwidth]{images/evaluation_fnn_s2}
	\caption[FNN Evaluation: Number of Training Epochs]{The evaluation results of the FNN for parameter $n$: the number of training epochs. Number of correctly tagged words in percent.}
	\label{f.evaluation.fnn.s2}
\end{figure}

\begin{figure}[H]
	\includegraphics[width=\textwidth]{images/evaluation_fnn_a}
	\caption[FNN Evaluation: Number of Training Epochs]{The evaluation results of the FNN for parameter $n$: the number of training epochs. Number of correctly tagged words in percent.}
