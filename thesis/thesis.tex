...
The modular structure of \i{Alex} allows for easier separation of various functions and therefore easier replaceability of a certain functionality. One of these modules is the HMM-Tagger, which is used to train a language model on the one hand and to assign tags to the words of a given sentence on the other hand.
