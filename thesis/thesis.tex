...
\begin{table}[H]
	\vspace{1ex}\small\centering\def\arraystretch{1.1}\begin{tabular}{|>{\raggedright}p{43mm}|>{\raggedright}p{43mm}|>{\raggedright}p{43mm}|c|}
	\hline
	...
	\end{tabular}
	\caption[Sentence Template Improvements]{An excerpt of the extension and improvement of the sentence templates by using inline choices. The last column provides an English translation for the new sentence template.}
	\label{t.improved_sentence_templates}
	\vspace{1ex}
\end{table}

At last some new sentence templates were added, that provide a sentence structure that was found in the logs. The new set contains \tt{100} sentence or single word templates and can be found in the appendix \ref{c.appendix.sentencetemplates}.
