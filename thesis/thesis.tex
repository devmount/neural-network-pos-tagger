...
% Learning is a fundamental part of the human life, from the beginning to the end
% learning means progress, additional value, not to repeat failures
% Learning is biological possible with Neurons, combined to a huge neural Network.
