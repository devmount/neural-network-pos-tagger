...
\lstinputlisting[language=JSON, label={l.tagdata}]{listings/method-tag-input.example}

The output is a corresponding list of tuples containing a word and its assigned tag (see Listing \ref{l.tagdata}).

\lstinputlisting[language=JSON, label={l.tagdata}]{listings/method-tag-output.example}
