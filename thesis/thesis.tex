...
\begin{table}[H]
	\small\def\arraystretch{1.2}\begin{tabular}{ p{2mm} L{48mm} p{35mm} p{40mm} }
	\toprule
...
\begin{table}[H]
	\small\def\arraystretch{1.2}\begin{tabular}{ L{43mm} L{43mm} p{43mm} }
	\toprule
...
At last \tt{28} new sentence templates were added, that provide a sentence structure that was found in the logs but not in the former template set. The new set contains \tt{100} sentence or single word templates and can be found in the appendix \ref{c.appendix.sentencetemplates}.
...
The following tables shows the different topics, their respective number of evaluation sentences and one sentence as an illustration for each topic.

\begin{table}[H]
	\centering\small\def\arraystretch{1.2}\begin{tabular}{ p{20mm} c L{35mm} }
	\toprule
	\textsc{Topic} & \textsc{Count} & \multicolumn{1}{L{43mm}}{\textsc{Example}} \\
	\midrule
	\midrule
	ECTS & \tt{0} & \multicolumn{1}{L{43mm}}{\i{test}} \\
	\midrule
	Time & \tt{0} & \multicolumn{1}{L{43mm}}{\i{test}} \\
	\midrule
	Faculty & \tt{0} & \multicolumn{1}{L{43mm}}{\i{test}} \\
	\midrule
	Participants & \tt{0} & \multicolumn{1}{L{43mm}}{\i{test}} \\
	\midrule
	Persons & \tt{0} & \multicolumn{1}{L{43mm}}{\i{test}} \\
	\midrule
	Program & \tt{0} & \multicolumn{1}{L{43mm}}{\i{test}} \\
	\midrule
	Modules & \tt{0} & \multicolumn{1}{L{43mm}}{\i{test}} \\
	\midrule
	Chair & \tt{0} & \multicolumn{1}{L{43mm}}{\i{test}} \\
	\midrule
	Exam & \tt{0} & \multicolumn{1}{L{43mm}}{\i{test}} \\
	\midrule
	Courses & \tt{0} & \multicolumn{1}{L{43mm}}{\i{test}} \\
	\midrule
	Locations & \tt{0} & \multicolumn{1}{L{43mm}}{\i{test}} \\
	\bottomrule
	\end{tabular}
	\vspace{3mm}
	\caption[Evaluation Topics using the Known Test Set]{The evaluation topics, the number of tagged test sentences and an example sentence for each topic.}
