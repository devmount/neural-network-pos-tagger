...
% Since the HMM is only one of many processing elements of Alex, the implementation of the neural networks should be done without having to change other components of the conversational agent. If those changes are nevertheless necessary, they should be kept minimal.

% To train the neural network models, a large enough data corpus should be retrieved. Already existing logfiles of user data can be used for this purpose.
