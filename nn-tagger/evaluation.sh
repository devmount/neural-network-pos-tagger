...
for t in {1..12}; do
    if [ -d "storage/rnn-$t-50-100-1" ]; then
        ...
        python3.6 tagger.py --evaluate data/evaluation_known.txt -t $t -e 50 -s 50 -n 1 -i
        python3.6 tagger.py --evaluate data/evaluation_unknown.txt -t $t -e 50 -s 50 -n 1 -i
    fi
done
...
for e in 1 5 10 25 50 100; do
    if [ -d "storage/rnn-1-$e-100-1" ]; then
        ...
        python3.6 tagger.py --evaluate data/evaluation_known.txt -t 1 -e $e -s 50 -n 1 -i
        python3.6 tagger.py --evaluate data/evaluation_unknown.txt -t 1 -e $e -s 50 -n 1 -i
    fi
done
...
for s in 10 25 50 100 150 200; do
    if [ -d "storage/rnn-1-50-$s-1" ]; then
        ...
        python3.6 tagger.py --evaluate data/evaluation_known.txt -t 1 -e 50 -s $s -n 1 -i
        python3.6 tagger.py --evaluate data/evaluation_unknown.txt -t 1 -e 50 -s $s -n 1 -i
    fi
done
...
for n in 1 5 10 20; do
    if [ -d "storage/rnn-1-50-100-$n" ]; then
        ...
        python3.6 tagger.py --evaluate data/evaluation_known.txt -t 1 -e 50 -s 50 -n $n -i
        python3.6 tagger.py --evaluate data/evaluation_unknown.txt -t 1 -e 50 -s 50 -n $n -i
    fi
done
